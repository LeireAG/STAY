...
- figure_1/ - code to execute detachment rate estimation, corresponding statistical testing and plotting from spaceranger outputs across STAY and standard protocols. 
...
First author: Leire Alonso Galicia [leire.alonso@scilifelab.se](mailto:leire.alonso@scilifelab.se) 