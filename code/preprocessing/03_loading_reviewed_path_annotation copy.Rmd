...
# Plot
p_immune <- ggplot(plot.df_immune, aes(y = nCount_Spatial, x = patient, fill = method)) +
  geom_violin(trim = FALSE, scale = "width", width = 1) +
...
#testing scales for stroma layer
...
png_res <- 1200
png(filename = "/Users/leirealonso/Documents/ST/Project_Garvan_institute/Human_Breast_Cancer_Atlas/hard_vs_soft_cover/for_manuscripts/analysis/results_LA/updated_reworked_annotations/stroma_comparisonlog10.png", width = 10*png_res, height = 8*png_res, res = png_res);print(p_stroma);dev.off()
```
